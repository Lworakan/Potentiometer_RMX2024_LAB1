###########################################################################
## Makefile generated for component 'potenlab'. 
## 
## Makefile     : potenlab.mk
## Generated on : Tue Oct 08 01:22:28 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/potenlab.elf
...
PRODUCT_NAME              = potenlab
MAKEFILE                  = potenlab.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/Lenovo/Desktop/RMX/FRA231-Robotics-Modelling-and-Experimentation-2024-main/FRA231-Robotics-Modelling-and-Experimentation-2024-main
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = potenlab_comp.rsp
CMD_FILE                  = potenlab.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/potenlab.elf
...
DEFINES_STANDARD = -DMODEL=potenlab -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/shared/supportpackages/stm32/src/stm_adc_ll.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_mode.c $(START_DIR)/potenlab_ert_rtw/potenlab.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_common.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_classic_trigger.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_standard.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_daq.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src/xcp_calibration.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_fifo.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_transport.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_mem_default.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default/xcp_drv_rtiostream.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common/xcp_utils.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src/xcp_frame_serial.c $(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src/xcp_ext_param_default_serial.c C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/shared/supportpackages/stm32/src/overrideHALDelay.c C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/shared/supportpackages/stm32/src/platform_timer.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/SysTickScheduler.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/scheduler/src/m3m4m4f_multitasking.c C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/shared/supportpackages/stm32/src/rtiostream_serial.c C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/shared/supportpackages/stm32/src/stm_usart.c C:/ProgramData/MATLAB/SupportPackages/R2024b/toolbox/shared/supportpackages/stm32/src/stm_lpuart.c $(MATLAB_ROOT)/toolbox/target/shared/armcortexmbase/xcp/src/sys_arch.c $(START_DIR)/Proten/Core/Src/main.c $(START_DIR)/Proten/Core/Src/stm32g4xx_it.c $(START_DIR)/Proten/Core/Src/stm32g4xx_hal_msp.c $(START_DIR)/Proten/Core/Src/stm32g4xx_hal_timebase_tim.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_utils.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_exti.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_gpio.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_adc.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dma.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_pwr.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_rcc.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_rcc_ex.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ramfunc.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr_ex.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_tim.c $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_tim_ex.c $(START_DIR)/Proten/Core/Src/system_stm32g4xx.c $(START_DIR)/Proten/STM32CubeIDE/Application/User/Core/syscalls.c $(START_DIR)/Proten/STM32CubeIDE/Application/User/Core/sysmem.c $(START_DIR)/Proten/STM32CubeIDE/Application/User/Startup/startup_stm32g474retx.s

MAIN_SRC = $(START_DIR)/potenlab_ert_rtw/ert_main.c
...
OBJS = stm_adc_ll.o xcp_ext_mode.o potenlab.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o overrideHALDelay.o platform_timer.o SysTickScheduler.o m3m4m4f_multitasking.o rtiostream_serial.o stm_usart.o stm_lpuart.o sys_arch.o main.o stm32g4xx_it.o stm32g4xx_hal_msp.o stm32g4xx_hal_timebase_tim.o stm32g4xx_ll_utils.o stm32g4xx_ll_exti.o stm32g4xx_ll_gpio.o stm32g4xx_ll_adc.o stm32g4xx_ll_dma.o stm32g4xx_ll_pwr.o stm32g4xx_hal.o stm32g4xx_hal_rcc.o stm32g4xx_hal_rcc_ex.o stm32g4xx_hal_flash.o stm32g4xx_hal_flash_ex.o stm32g4xx_hal_flash_ramfunc.o stm32g4xx_hal_gpio.o stm32g4xx_hal_exti.o stm32g4xx_hal_dma.o stm32g4xx_hal_dma_ex.o stm32g4xx_hal_pwr.o stm32g4xx_hal_pwr_ex.o stm32g4xx_hal_cortex.o stm32g4xx_ll_lpuart.o stm32g4xx_ll_rcc.o stm32g4xx_hal_tim.o stm32g4xx_hal_tim_ex.o system_stm32g4xx.o syscalls.o sysmem.o startup_stm32g474retx.o
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m4 -mthumb -mlittle-endian -mthumb-interwork -mfpu=fpv4-sp-d16 -mfloat-abi=hard --entry Reset_Handler --specs=nosys.specs  -T"C:\Users\Lenovo\Desktop\RMX\FRA231-Robotics-Modelling-and-Experimentation-2024-main\FRA231-Robotics-Modelling-and-Experimentation-2024-main\Proten\STM32CubeIDE\STM32G474RETX_FLASH.ld"
...
%.o : $(START_DIR)/potenlab_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/potenlab_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/potenlab_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/potenlab_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/potenlab_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/potenlab_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


potenlab.o : $(START_DIR)/potenlab_ert_rtw/potenlab.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
main.o : $(START_DIR)/Proten/Core/Src/main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_it.o : $(START_DIR)/Proten/Core/Src/stm32g4xx_it.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_msp.o : $(START_DIR)/Proten/Core/Src/stm32g4xx_hal_msp.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_timebase_tim.o : $(START_DIR)/Proten/Core/Src/stm32g4xx_hal_timebase_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_utils.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_utils.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_exti.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_exti.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_gpio.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_gpio.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_adc.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_adc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_dma.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_dma.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_pwr.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_pwr.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_rcc.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_rcc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_rcc_ex.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_rcc_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_flash.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_flash_ex.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_flash_ramfunc.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_flash_ramfunc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_gpio.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_gpio.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_exti.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_exti.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_dma.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_dma_ex.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_dma_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_pwr.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_pwr_ex.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_pwr_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_cortex.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_cortex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_lpuart.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_lpuart.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_ll_rcc.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_ll_rcc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_tim.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32g4xx_hal_tim_ex.o : $(START_DIR)/Proten/Drivers/STM32G4xx_HAL_Driver/Src/stm32g4xx_hal_tim_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


system_stm32g4xx.o : $(START_DIR)/Proten/Core/Src/system_stm32g4xx.c
	$(CC) $(CFLAGS) -o "$@" "$<"


syscalls.o : $(START_DIR)/Proten/STM32CubeIDE/Application/User/Core/syscalls.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sysmem.o : $(START_DIR)/Proten/STM32CubeIDE/Application/User/Core/sysmem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


startup_stm32g474retx.o : $(START_DIR)/Proten/STM32CubeIDE/Application/User/Startup/startup_stm32g474retx.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
